...
layout: page
permalink: >
  https://bar-auditorium.fr/programmes/artistes/
published: true
...
<ul id="elementor-navmenu">
 	<li id="menu-item-67"><a href="https://bar-auditorium.fr/">Acceuil</a></li>
...
<ul id="mega-menu">
 	<li id="menu-item-177"><a href="https://bar-auditorium.fr/artistes/">ARTISTES</a></li>
 	<li id="menu-item-176"><a href="https://bar-auditorium.fr/horaires/">HORAIRES</a></li>
</ul>
</nav>
<h2>ACTUALITÉS</h2>
<article>
...
<h4>NEWSLETTER</h4>
<form action="https://bar-auditorium.fr/wp-admin/admin-post.php" method="post" name="content-form-6bab1a7c" id="content-form-6bab1a7c"><input type="hidden" id="_wpnonce_newsletter" name="_wpnonce_newsletter" value="fed6f81b5c"><input type="hidden" name="_wp_http_referer" value="/wp-admin/admin-ajax.php"><input type="hidden" name="action" value="content_form_submit"><input type="hidden" name="form-type" value="newsletter"><input type="hidden" name="form-builder" value="elementor"><input type="hidden" name="post-id" value="71"><input type="hidden" name="form-id" value="6bab1a7c">
<fieldset>
            <label for="data[6bab1a7c][email]">
Email *            </label>
<input type="text" name="data[6bab1a7c][email]" id="data[6bab1a7c][email]" required="required" placeholder="Adresse Email"></fieldset>
<fieldset>
            <button type="submit" name="submit" value="submit-newsletter-6bab1a7c">
