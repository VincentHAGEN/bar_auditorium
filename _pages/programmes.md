...
<li><a href="https://bar-auditorium.fr/contact/">Contact</a></li>
		...
		<p>Acceuil &gt;&gt; Programme</p>		
			...
			<h4>NEWSLETTER</h4>		
			<form action="https://bar-auditorium.fr/wp-admin/admin-post.php" method="post" name="content-form-3533adae" id="content-form-3533adae"><input type="hidden" id="_wpnonce_newsletter" name="_wpnonce_newsletter" value="3dae115660" /><input type="hidden" name="_wp_http_referer" value="/wp-admin/admin-ajax.php" /><input type="hidden" name="action" value="content_form_submit" /><input type="hidden" name="form-type" value="newsletter" /><input type="hidden" name="form-builder" value="elementor" /><input type="hidden" name="post-id" value="75" /><input type="hidden" name="form-id" value="3533adae" />
        <fieldset>
