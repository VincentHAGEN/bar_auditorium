...
<li><a href="https://bar-auditorium.fr/contact/">Contact</a></li>
		...
		<nav itemtype="http://schema.org/SiteNavigationElement" itemscope="itemscope" id="cbp-hsmenu-wrapper">
				<ul id="mega-menu"><li><a href="https://bar-auditorium.fr/artistes/">ARTISTES</a></li>
<li><a href="https://bar-auditorium.fr/horaires/">HORAIRES</a></li>
</ul>			
		</nav>
			<h2>ACTUALITÉS </h2>		
			<article>					
			...
			<h4>NEWSLETTER</h4>		
			<form action="https://bar-auditorium.fr/wp-admin/admin-post.php" method="post" name="content-form-681ff063" id="content-form-681ff063"><input type="hidden" id="_wpnonce_newsletter" name="_wpnonce_newsletter" value="17cd1a2a82" /><input type="hidden" name="_wp_http_referer" value="/wp-admin/admin-ajax.php" /><input type="hidden" name="action" value="content_form_submit" /><input type="hidden" name="form-type" value="newsletter" /><input type="hidden" name="form-builder" value="elementor" /><input type="hidden" name="post-id" value="75" /><input type="hidden" name="form-id" value="681ff063" />
        <fieldset>
