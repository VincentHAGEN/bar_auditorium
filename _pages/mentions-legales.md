...
<li><a href="https://bar-auditorium.fr/contact/">Contact</a></li>
		...
		<p>Acceuil &gt;&gt; Mentions légales</p><p><!-- wp:paragraph --></p>
...
<p><!-- /wp:paragraph --></p>		
        ...
        <fieldset>
            <label for="data[2083757d][email]"
				>
				Email *            </label>
			                    <input type="text" name="data[2083757d][email]" id="data[2083757d][email]"
						required="required"  placeholder="Adresse Email">
					        </fieldset>
		        <fieldset>
            <button type="submit" name="submit" value="submit-newsletter-2083757d">
	            INSCRIPTION                            </button>
        </fieldset>
		</form>		
			<h4>SUIVEZ-NOUS</h4>		
